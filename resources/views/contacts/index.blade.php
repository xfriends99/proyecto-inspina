                ...
                <main class="wrapper wrapper-content animated fadeInRight">
                    <div class="row">
                        ...
                        <div class="side-0">
                            ...
                            <section>
                                <div class="btn-group">
                                    <a class="btn btn-white btn-sm active" href="contactos-table.php" title="Ver en tabla"><i class="fa fa-table"></i></a>
                                    <a class="btn btn-white btn-sm" href="contactos-mosaico.php" title="Ver en Fichas"><i class="fa fa-align-justify"></i></a>
                                </div>
                                <div class="btn-group">
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-blue btn-sm" href="{{route('contact.create')}}" title="Crear nuevo contacto"><i class="fa fa-plus"></i> Nuevo</a>
                                </div>
                            </section>
                        </div>
                    </div>
